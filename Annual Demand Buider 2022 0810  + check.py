...
## !!! I found that there is no need to calculate cagr. Directly using growth rate is better and more accurate. 
...
table1 = pd.read_excel(r'C:\Users\jiaxi\OneDrive\Desktop\RBAC 2022\Demand\Demand Annual Builder\2022 0810\Input Data 2022 0810-run.xlsx', sheet_name = 'Target2')
...
yrs = pd.read_excel(r'C:\Users\jiaxi\OneDrive\Desktop\RBAC 2022\Demand\Demand Annual Builder\2022 0810\Input Final Scenario 2022 0810.xlsx', sheet_name = 'Yr_Index')

# COM
data = table.drop(['lelc', 'lind', 'lres', 'ltrn', 'lpet', 'lgdp_man', 'lche', 'lfoo', 'lmac', 'ltex', 'loth', 'lgasprice', 'loilprice'], axis = 1)

r_table = pd.read_excel(r'C:\\Users\\jiaxi\\OneDrive\\Desktop\\RBAC 2022\\Demand\\Demand Annual Builder\\2022 0810\\Input Scenarios 2022 0810.xlsx', sheet_name = 'COM')
        ...
        if i in ref_country:
                ...
                for i in aclist:
                    ...
                    def fun(x): # this function is to calculate cagr, test for delete useless rows
                      if x == 2023 or x == 2022: # the base year that you would like to calculate cagr
                        return 0
                      else:
                        return 1
                    cagr['test2'] =cagr['Year'].apply(lambda x: fun(x))
                    cagr['test'] = cagr['test1'] * cagr['test2']
                    cagr = cagr[cagr["test"] == 0]
                    ...
                    cagr_check = cagr_check.drop(cagr_check[cagr_check.Year == 2023 ].index)
                    ...
                    cagr_check['CAGR'] = (cagr_check['value'] / cagr_check['value'].shift(+1) ) ** (1/28) - 1 # 2050 - base year
...
r_table = pd.read_excel(r'C:\Users\jiaxi\OneDrive\Desktop\RBAC 2022\Demand\Demand Annual Builder\2022 0810\Input Scenarios 2022 0810.xlsx', sheet_name = 'IND')
...
r_table = pd.read_excel(r'C:\Users\jiaxi\OneDrive\Desktop\RBAC 2022\Demand\Demand Annual Builder\2022 0810\Input Scenarios 2022 0810.xlsx', sheet_name = 'IND2')
...
r_table = pd.read_excel(r'C:\Users\jiaxi\OneDrive\Desktop\RBAC 2022\Demand\Demand Annual Builder\2022 0810\Input Scenarios 2022 0810.xlsx', sheet_name = 'IND3')
...
r_table = pd.read_excel(r'C:\Users\jiaxi\OneDrive\Desktop\RBAC 2022\Demand\Demand Annual Builder\2022 0810\Input Scenarios 2022 0810.xlsx', sheet_name = 'RES')
...
r_table = pd.read_excel(r'C:\Users\jiaxi\OneDrive\Desktop\RBAC 2022\Demand\Demand Annual Builder\2022 0810\Input Scenarios 2022 0810.xlsx', sheet_name = 'TRN')
...
totalresult.to_csv(r'C:\Users\jiaxi\OneDrive\Desktop\RBAC 2022\Demand\Demand Annual Builder\2022 0810\Output - Total Results 2022 0810.csv',index=None)
totalforecast.to_csv(r'C:\Users\jiaxi\OneDrive\Desktop\RBAC 2022\Demand\Demand Annual Builder\2022 0810\Output - Total Forecast 2022 0810.csv',index=None)
totalregID.to_csv(r'C:\Users\jiaxi\OneDrive\Desktop\RBAC 2022\Demand\Demand Annual Builder\2022 0810\Output - Total RegID 2022 0810.csv',index=None)
totalcagr.to_csv(r'C:\Users\jiaxi\OneDrive\Desktop\RBAC 2022\Demand\Demand Annual Builder\2022 0810\Output - Total CAGR 2022 0810.csv',index=None)
totalcagr_check.to_csv(r'C:\Users\jiaxi\OneDrive\Desktop\RBAC 2022\Demand\Demand Annual Builder\2022 0810\Output - Total CAGR Check 2022 0810.csv',index=None)
...
########## final selection
select = pd.read_excel(r'C:\Users\jiaxi\OneDrive\Desktop\RBAC 2022\Demand\Demand Annual Builder\2022 0810\Input Final Scenario 2022 0810.xlsx', sheet_name = 'Map')
...
selectresult.to_csv(r'C:\Users\jiaxi\OneDrive\Desktop\RBAC 2022\Demand\Demand Annual Builder\2022 0810\Output - Final Results 2022 0810.csv',index=None)
selectforecast.to_csv(r'C:\Users\jiaxi\OneDrive\Desktop\RBAC 2022\Demand\Demand Annual Builder\2022 0810\Output - Final Forecast 2022 0810.csv',index=None)
selectcagr.to_csv(r'C:\Users\jiaxi\OneDrive\Desktop\RBAC 2022\Demand\Demand Annual Builder\2022 0810\Output - Final CAGR 2022 0810.csv',index=None)
selectcagr_check.to_csv(r'C:\Users\jiaxi\OneDrive\Desktop\RBAC 2022\Demand\Demand Annual Builder\2022 0810\Output - Final CAGR Check 2022 0810.csv',index=None)
