...
# 2021
df = tabula.read_pdf("C:\\Users\\jiaxi\\OneDrive\\Desktop\\RBAC 2022\\Local\\Indonesia\\content-handbook-of-energy-and-economic-statistics-of-indonesia-2021.pdf", pages='21')
a = df[0]
B = [["Local", "2021","", "Indonesia", "production", "",  "thousand BOE", a.iloc[11,11]], \
     ["Local", "2021","", "Indonesia", "consumption", "ELC",  "thousand BOE", a.iloc[21,11]], \
     ["Local", "2021","", "Indonesia", "consumption", "IND",  "thousand BOE", a.iloc[38,11]], \
     ["Local", "2021","", "Indonesia", "consumption", "TRN",  "thousand BOE", a.iloc[39,11]], \
     ["Local", "2021","", "Indonesia", "consumption", "RES",  "thousand BOE", a.iloc[40,11]], \
     ["Local", "2021","", "Indonesia", "consumption", "COM",  "thousand BOE", a.iloc[41,11]]]   
z21 = pd.DataFrame(B,columns=["source", "year", "period", "country", "sector", "sector2", "unit", "value"])
...
b = a.iloc[5,7]
Output1 = [z21, z20, z19, z18, z17, z16, z15, z14, z13, z12, z11]

Output2 = pd.concat(Output1)

Output2.to_csv("C:\\Users\\jiaxi\\OneDrive\\Desktop\\RBAC 2022\\Local\\Indonesia\\Consumption by sector output 2022 0705.csv",index=None)
