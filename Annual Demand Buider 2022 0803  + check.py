...
table1 = pd.read_excel(r'C:\Users\jiaxi\OneDrive\Desktop\RBAC 2022\Demand\Demand Annual Builder\2022 0803\Input Data 2022 0803-run.xlsx', sheet_name = 'Target2')
...
yrs = pd.read_excel(r'C:\Users\jiaxi\OneDrive\Desktop\RBAC 2022\Demand\Demand Annual Builder\2022 0803\Input Final Scenario 2022 0803.xlsx', sheet_name = 'Yr_Index')

# COM
data = table.drop(['lelc', 'lind', 'lres', 'ltrn', 'lpet', 'lgdp_man', 'lche', 'lfoo', 'lmac', 'ltex', 'loth', 'lgasprice', 'loilprice'], axis = 1)

r_table = pd.read_excel(r'C:\\Users\\jiaxi\\OneDrive\\Desktop\\RBAC 2022\\Demand\\Demand Annual Builder\\2022 0803\\Input Scenarios 2022 0803.xlsx', sheet_name = 'COM')
...
r_table = pd.read_excel(r'C:\Users\jiaxi\OneDrive\Desktop\RBAC 2022\Demand\Demand Annual Builder\2022 0803\Input Scenarios 2022 0803.xlsx', sheet_name = 'IND')
...
r_table = pd.read_excel(r'C:\Users\jiaxi\OneDrive\Desktop\RBAC 2022\Demand\Demand Annual Builder\2022 0803\Input Scenarios 2022 0803.xlsx', sheet_name = 'IND2')
...
r_table = pd.read_excel(r'C:\Users\jiaxi\OneDrive\Desktop\RBAC 2022\Demand\Demand Annual Builder\2022 0803\Input Scenarios 2022 0803.xlsx', sheet_name = 'IND3')
...
r_table = pd.read_excel(r'C:\Users\jiaxi\OneDrive\Desktop\RBAC 2022\Demand\Demand Annual Builder\2022 0803\Input Scenarios 2022 0803.xlsx', sheet_name = 'RES')
...
r_table = pd.read_excel(r'C:\Users\jiaxi\OneDrive\Desktop\RBAC 2022\Demand\Demand Annual Builder\2022 0803\Input Scenarios 2022 0803.xlsx', sheet_name = 'TRN')
...
totalresult.to_csv(r'C:\Users\jiaxi\OneDrive\Desktop\RBAC 2022\Demand\Demand Annual Builder\2022 0803\Output - Total Results 2022 0803.csv',index=None)
totalforecast.to_csv(r'C:\Users\jiaxi\OneDrive\Desktop\RBAC 2022\Demand\Demand Annual Builder\2022 0803\Output - Total Forecast 2022 0803.csv',index=None)
totalregID.to_csv(r'C:\Users\jiaxi\OneDrive\Desktop\RBAC 2022\Demand\Demand Annual Builder\2022 0803\Output - Total RegID 2022 0803.csv',index=None)
totalcagr.to_csv(r'C:\Users\jiaxi\OneDrive\Desktop\RBAC 2022\Demand\Demand Annual Builder\2022 0803\Output - Total CAGR 2022 0803.csv',index=None)
totalcagr_check.to_csv(r'C:\Users\jiaxi\OneDrive\Desktop\RBAC 2022\Demand\Demand Annual Builder\2022 0803\Output - Total CAGR Check 2022 0803.csv',index=None)
...
########## final selection
select = pd.read_excel(r'C:\Users\jiaxi\OneDrive\Desktop\RBAC 2022\Demand\Demand Annual Builder\2022 0803\Input Final Scenario 2022 0803.xlsx', sheet_name = 'Map')
...
selectresult.to_csv(r'C:\Users\jiaxi\OneDrive\Desktop\RBAC 2022\Demand\Demand Annual Builder\2022 0803\Output - Final Results 2022 0803.csv',index=None)
selectforecast.to_csv(r'C:\Users\jiaxi\OneDrive\Desktop\RBAC 2022\Demand\Demand Annual Builder\2022 0803\Output - Final Forecast 2022 0803.csv',index=None)
selectcagr.to_csv(r'C:\Users\jiaxi\OneDrive\Desktop\RBAC 2022\Demand\Demand Annual Builder\2022 0803\Output - Final CAGR 2022 0803.csv',index=None)
selectcagr_check.to_csv(r'C:\Users\jiaxi\OneDrive\Desktop\RBAC 2022\Demand\Demand Annual Builder\2022 0803\Output - Final CAGR Check 2022 0803.csv',index=None)
